...
<template>
  ...
  >
    ...
    >
      <CommonSectionLeft :section-left="sectionLeft" @button-toggle="$emit('buttonToggle')"/>
      <CommonSectionRight :section-right="sectionRight" @button-toggle="$emit('buttonToggle')"/>
    </div>
    <div
      class="page__overlay"
